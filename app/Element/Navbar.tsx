...
export default function Navbar() {
  ...
  return (
    <View
      className={`flex-row justify-between items-center px-4 mt-20`}
    ...
    >
      ...
      <View className="flex-row items-center">
        ...
        {/* Name badge */}
        <View className={`bg-orange-500 px-5 pl-45 py-1 rounded-full shadow-lg`}>
      ...
      <View className="flex-row gap-5">
        ...
        <TouchableOpacity
          className={`w-12 h-12 rounded-full shadow items-center justify-center ${isDark ? "bg-gray-700" : "bg-white"}`}
        >
          <Cog6ToothIcon color={isDark ? "#FB923C" : "#FB923C"} size={iconSize} />
        </TouchableOpacity>
      </View>
    </View>
  );
