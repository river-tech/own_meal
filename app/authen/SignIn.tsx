  ...
  return (
    <ScrollView
      contentContainerStyle={{
        ...
        alignItems: 'center',
        padding: 20,
        backgroundColor: colorScheme === 'dark' ? '#1E1E1E' : '#F5F5F5', // Nền thay đổi tùy theo chế độ sáng/tối
      }}
    >
      {/* Nút Back */}
    <View className="absolute top-20 left-6">
  <TouchableOpacity onPress={() => router.push('/')}>
    <Text className={`text-5xl ${colorScheme === 'dark' ? 'text-orange-600' : 'text-black'} font-bold`}>
      ←
    </Text>
  </TouchableOpacity>
</View>
      ...
      >
        ...
        <TextInput
          ...
          className={`bg-${colorScheme === 'dark' ? 'gray-800' : 'white'} p-4 mb-4 rounded-lg shadow-lg ${colorScheme === 'light' ? 'border-2 border-gray-300 text-black' : ' text-white'}`}
        />
